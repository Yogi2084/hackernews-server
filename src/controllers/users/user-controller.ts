...
import { GetMeError, type GetMeResult, type GetAllUsersResult, GetAllUsersError } from "./user-type";
...
export const GetAllUsers = async (parameter:{
  ...
  try {
    ...
    if (totalUsers === 0) {
      throw GetAllUsersError.USERS_NOT_FOUND;
    }
    ...
    console.error(e);
    if (
      e === GetAllUsersError.USERS_NOT_FOUND ||
